                        ...
                        <div class="p-5" style="width:700px;">
                            ...
                            <div class="float-right no-print">
                                ...
                                <form action="/payment_confirm" method="POST">
                                    @csrf
                                    <small class="float-right">*Rekening Mu</small>
                                    <input type="number" class="form-control float-right mb-2" name="rekening" style="width:80%;" placeholder="0000-0000-0000" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required><br>

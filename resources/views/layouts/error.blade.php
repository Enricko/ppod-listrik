...
<body>
    {{-- <div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <i class="fa-solid fa-triangle-exclamation fa-10x text-center" style="margin-top:150px;">
            <h3>You Don't Have Permission So Please Go Back!!</h3>
      ...
      <section class="error">
        ...
        <div class="error__content">
          ...
          <div class="error__nav e-nav">
            <a href="javascript:history.back()" class="e-nav__link"></a>
          </div>
        </div>
        <!-- END Content -->
